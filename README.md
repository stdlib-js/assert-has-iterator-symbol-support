...
```javascript
hasIteratorSymbolSupport = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-has-iterator-symbol-support@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-has-iterator-symbol-support@umd/bundle.js"></script>
```
